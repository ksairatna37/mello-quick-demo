...
void main() {
  ...
  vec3 auroraColor = pow(intensity * rampColor, vec3(1.0/2.0));
...
export default function Aurora({ colorStops = ["#00eaff", "#ffffff", "#00eaff"], amplitude = 1.0, blend = 0.5, ...props }: AuroraProps) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      const { speed = 1.0, time = t * 0.01 } = propsRef.current;
